...
// 廳六 法庭
const C6 = {
  // ★ 第 3 階段整合修正：規格寫 12×16，但廳六要同時容納「其餘 38 台分列兩側陰影」。
  //   單台車長 4.4 m、寬 1.8 m；每側 19 台縱向排開至少需要 19×1.9 ≈ 36 m 的深度，
  //   而 12 m 的寬度扣掉直徑 4.6 m 的被告席後，兩側各剩 3.7 m，連一台車的長度都放不下。
  //   12×16 與「38 台分列兩側」在物理上互斥。放大為 14 × 44，兩側陰影區各 4.5 m 維持不變。
  W: 14.0, D: 44.0, H: 5.00,            // 14 × 44 m，天花板 5.0 m
  WALL_T: 0.35,
